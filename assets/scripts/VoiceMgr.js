...
cc.Class({
    ...
    prepare:function(filename){
        ...
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/bestwpb/voicesdk/VoiceRecorder", "prepare", "(Ljava/lang/String;)V",filename);
        }
    ...
    release:function(){
        ...
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/bestwpb/voicesdk/VoiceRecorder", "release", "()V");
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
    ...
    cancel:function(){
        ...
        cc.vv.audioMgr.resumeAll();
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/bestwpb/voicesdk/VoiceRecorder", "cancel", "()V");
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
    ...
    play:function(filename){
        ...
        cc.vv.audioMgr.pauseAll();
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/bestwpb/voicesdk/VoicePlayer", "play", "(Ljava/lang/String;)V",filename); 
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
    ...
    stop:function(){
        ...
        cc.vv.audioMgr.resumeAll();
        if(cc.sys.os == cc.sys.OS_ANDROID){
            jsb.reflection.callStaticMethod("com/bestwpb/voicesdk/VoicePlayer", "stop", "()V"); 
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
    ...
    getVoiceLevel:function(maxLevel){
        ...
        if(cc.sys.os == cc.sys.OS_ANDROID){ 
            return jsb.reflection.callStaticMethod("com/bestwpb/voicesdk/VoiceRecorder", "getVoiceLevel", "(I)I",maxLevel);
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
        }
        else{
    ...
    getVoiceData:function(filename){
        if(cc.sys.isNative){
            var url = this._voiceMediaPath + filename;
            if(cc.vv.dataMgr.DEBUG) console.log("getVoiceData:" + url);
            var fileData = jsb.fileUtils.getDataFromFile(url);
            if(fileData){
                var content = encode(fileData);
                return content;
    ...
    setStorageDir:function(dir){
        ...
        if(cc.sys.os == cc.sys.OS_ANDROID){ 
            jsb.reflection.callStaticMethod("com/bestwpb/voicesdk/VoiceRecorder", "setStorageDir", "(Ljava/lang/String;)V",dir);    
        }
        else if(cc.sys.os == cc.sys.OS_IOS){
